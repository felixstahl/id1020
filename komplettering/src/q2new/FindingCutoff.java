...
public class FindingCutoff {
    ...
    public static void main(String[] args) {
        if (args.length == 1 && args[0].equals("test")) {
            ...
            Integer[] intArray1 = makeRandomIntArray(N, K, DEFAULT_SEED);
    ...
    private static <U extends Comparable> void quicksort(Comparable[] array) {
    ...
    private static void testMakeRandomInts() {
        ...
        Integer[] ints = makeRandomIntArray(count, max, seed);
        ...
        Integer[] ints2 = makeRandomIntArray(count, max, 7);
        boolean isDifferent = false;
        for (int i = 0; i < ints.length; i++) {
